...
def atomic_module_payload() -> dict[str, Any]:
    return {
...
def subflow_template_payload() -> dict[str, Any]:
    return {
...
def system_pattern_payload() -> dict[str, Any]:
    return {
...
class RetrievalAgentPhase2ChromaHarness(unittest.TestCase):
    def setUp(self) -> None:
    ...
    def _populate_temp_chroma(self) -> None:
        ...
        atomic_payload = atomic_module_payload()
        ...
        subflow_payload = subflow_template_payload()
        ...
        pattern_payload = system_pattern_payload()
